...
copy /y "Corsair Effects Engine\bin\Debug\CSCore.dll" "CEE-Build-%newVer%\CSCore.dll"
...
copy /y "Corsair Effects Engine\bin\Debug\CSCore.dll" "CEE-Build-%newVer%-Update\CSCore.dll"
